...
```
- finally, copy the `cidata-K3os-091-c.iso` ISO to the image store of the Proxmox VE server
...
- after the reboot, you can login to the machine as user `rancher` with the preconfigured credentials
